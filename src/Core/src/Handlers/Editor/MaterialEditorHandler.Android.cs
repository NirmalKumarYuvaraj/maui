...
internal partial class MaterialEditorHandler : ViewHandler<IEditor, MauiMaterialEditor>
{
    bool _set;
    ...
    protected override MauiMaterialEditor CreatePlatformView()
    {
        var editText = new MauiMaterialEditor(Context)
        {
    ...
    protected override void ConnectHandler(MauiMaterialEditor platformView)
    {
        platformView.TextChanged += OnTextChanged;
        platformView.FocusChange += OnFocusChange;
    }

    protected override void DisconnectHandler(MauiMaterialEditor platformView)
    {
        platformView.TextChanged -= OnTextChanged;
        platformView.FocusChange -= OnFocusChange;
