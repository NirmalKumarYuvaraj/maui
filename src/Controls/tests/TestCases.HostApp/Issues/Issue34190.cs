...
{
	[Issue(IssueTracker.Github, 34190, "OnBackButtonPressed not firing for Shell Navigation Bar button on iOS", PlatformAffected.iOS | PlatformAffected.macOS)]
	public class Issue34190 : Shell
	{
		public Issue34190()
		{
