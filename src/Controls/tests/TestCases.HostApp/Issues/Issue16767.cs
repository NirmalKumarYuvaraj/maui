...
[Issue(IssueTracker.Github, 16767, "Resize and Downsize function in W2DImage class", PlatformAffected.UWP)]
public class Issue16767 : TestContentPage
{
	...
	private void OnResizeModeChanged(object sender, CheckedChangedEventArgs e)
	{
